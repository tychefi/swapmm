...
static const dex_pool_side_old_t LEFT_SIDE_POOL_OLD = {
    .balance = extended_asset(asset(0, FLON), "flon.token"_n),
    .total_quantity = asset(0, FLON)
};

static const dex_pool_side_old_t RIGHT_SIDE_POOL_OLD = {
...
struct global_old_t {
    ...
    dex_pool_side_old_t left_pool           = LEFT_SIDE_POOL_OLD;   // Left side pool info
    dex_pool_side_old_t right_pool          = RIGHT_SIDE_POOL_OLD;  // Right side pool info
