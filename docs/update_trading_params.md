...
mpush "$buylowsellhi_contract" settrademkt "$data" -p "$buylowsellhi_contract@active"
...
```bash
trade_pair="flon.usdt"
mpush "$buylowsellhi_contract" setslippage '["'$trade_updater'","'$trade_pair'",0.006,0.03]' -p "$trade_updater@active"
